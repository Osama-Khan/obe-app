...
import {ScrollView, PanResponder, Dimensions, ModalProps} from 'react-native';
import Reanimated, {EasingNode} from 'react-native-reanimated';
import Icon from '../icon';
import ModalBase from './modal-base';

export type BottomUpModalProps = ModalProps & {
  locked?: boolean;
  expanded?: boolean;
};
export default class BottomUpModal extends React.Component<
  ...
  any
> {
  height = new Reanimated.Value(
    this.props.expanded ? this.expandedHeight : this.collapsedHeight,
  );
  heightValue = this.props.expanded
    ? this.expandedHeight
    : this.collapsedHeight;
  modalHeight = this.props.expanded
    ? this.expandedHeight
    : this.collapsedHeight;
  _panResponder = this.props.locked
    ? undefined
    : PanResponder.create({
